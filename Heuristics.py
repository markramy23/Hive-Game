...
def minimax(hex_map: HexMap, depth, maximizingPlayer, player, hex_map_on_menu: HexMap):
    ...
    if GameOver(hex_map) or depth == 0:
        ...
        for move in moves:
            ...
            value = minimax(hex_map, depth - 1, not maximizingPlayer, get_next_player(player), hex_map_on_menu) #recursive call to calculate the value of the move
...
def nextMove(hex_map, hex_map_on_menu: HexMap, depth, player):
    ...
    for move in moves:
        ...
        value = minimax(hex_map, depth - 1, False, get_next_player(player), hex_map_on_menu)
